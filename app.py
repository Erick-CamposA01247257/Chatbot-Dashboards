...
def init_db():
    ...
    # Seed doctores de prueba
    demo_pass = hash_password("demo123")
    doctores_seed = [
        ("Dr. García",      "#3B82F6", 10, 15, "dr.garcia",      hash_password("garcia123")),
        ("Dra. Martínez",   "#8B5CF6", 11, 19, "dra.martinez",   hash_password("martinez123")),
        ("Dr. López",       "#F59E0B", 10, 17, "dr.lopez",       hash_password("lopez123")),
        ("Dra. Rodríguez",  "#10B981", 12, 19, "dra.rodriguez",  hash_password("rodriguez123")),
    ]
